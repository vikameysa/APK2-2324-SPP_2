        ...
        <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="?pages=user_admin">User Admin</a></li>
                        <li><a href="?pages=user_petugas">User Petugas</a></li>
                        <li><a href="?pages=user_karyawan">User Karyawan</a></li>
                        <li><a href="?pages=jabatan">Jabatan</a></li>
